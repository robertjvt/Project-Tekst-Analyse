...
# Calling program: 'python3 measures.py [filename1] [filename2]
# These filenames are the names that all the files should have in each folder.
# Example: 'python3 test2.py en.tok.off.pos.kylian en.tok.off.pos.robert'
# Description: This program will take annotated files and print two different
# classification reports along with a confusion matrix.
# Authors: Kylian de Rooij, Remi Thüss, Robert van Timmeren
# Date: 17-05-2021
